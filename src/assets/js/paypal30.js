const baseUrl30 = 'http://localhost:8000/api';
const token30 = localStorage.getItem('token');
...
paypal
  .Buttons({
    ...
    createOrder: function (data, actions) {
      return fetch(`${baseUrl30}/payment/paypal/create-order`, {
        method: "post",
        headers: {
    ...
    onApprove: function (data, actions) {
      return fetch(`${baseUrl30}/payment/paypal/capture-order`, {
        method: "post",
        headers: {
          "content-type": "application/json",
          Accept: "application/json",
